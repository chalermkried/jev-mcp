...
import type { askJev as Provider } from "./provider.js";
import {
...
// Both transports register the same tools. Credentials stay in the supplied evaluator.
export function registerJevTools(
  server: McpServer,
  askProvider: typeof Provider,
  MODEL: string,
): void {
